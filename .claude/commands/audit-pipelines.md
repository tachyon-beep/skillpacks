...
<!-- Content authority lives in plugins/axiom-audit-pipelines/skills/using-audit-pipelines/SKILL.md. Do not add inline router content to this command. -->
...
|------|---------|--------------------|
| XS | Single decision type, single producer, no export, internal-only | `00, 01, 02, 03, 06, 09`; `99` is a one-page memo |
| S | Multiple decision types under one ruleset, no cross-system export | XS set + `04, 07` |
