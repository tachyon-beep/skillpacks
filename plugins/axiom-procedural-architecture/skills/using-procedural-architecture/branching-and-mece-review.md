...
- [decomposition-smells.md](decomposition-smells.md) — the canonical smell catalog for smell naming and false-positive calibration: fake branches are an instance of the fake-branch smell, coverage gaps that leave a path unreachable may instantiate orphan-state, and option sets that force a choice before sufficient information exists may instantiate premature-commitment. A finding should cite the smell it instantiates.
