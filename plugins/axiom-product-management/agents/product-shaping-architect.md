...
| The **tracker** in use and any relevant IDs (filigree / GitHub Issues / Linear / Jira) | when present | The delivery package references tracker IDs; the backlog lives there, never duplicated into the workspace. |
