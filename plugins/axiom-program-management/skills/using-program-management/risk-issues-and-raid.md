...
The bands skip the numbers a 5×5 grid cannot produce: 7, 11, 13, and 14 are not the product of any two integers in 1–5, so Medium is really {8, 9, 10, 12} and High is {15, 16, 20, 25}. The gaps in the ranges are arithmetic, not typos.
