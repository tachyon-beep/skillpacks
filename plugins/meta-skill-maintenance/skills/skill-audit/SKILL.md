---
name: skill-audit
description: Use when auditing existing skills or skillpacks to verify they remain fit-for-purpose, follow best practices, and work with current Claude capabilities - dispatches subagents using TDD methodology to test skills under pressure, distinguishes minor fixes from major issues requiring operator review
---
