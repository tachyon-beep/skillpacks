...
> **For institutional register conventions** beyond the developer/operator/executive audience patterns described here — including policy language, government/regulatory voice, academic conventions, and public-facing prose — see [editorial-registers.md](editorial-registers.md).
