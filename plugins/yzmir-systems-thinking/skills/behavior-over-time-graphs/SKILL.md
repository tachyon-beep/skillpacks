---
name: behavior-over-time-graphs
description: Use when predicting future states, comparing scenarios, or communicating system dynamics over time - provides 7-step construction process with ASCII standards and validation checklist to create clear, accurate behavior-over-time graphs that show trajectories, equilibria, and phase transitions
---
