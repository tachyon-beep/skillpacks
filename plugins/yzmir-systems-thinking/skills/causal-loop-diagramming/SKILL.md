---
name: causal-loop-diagramming
description: Use when exploring why problems persist despite fixes, communicating system structure to stakeholders, or identifying feedback loops - provides systematic construction process with validation checklist to create clear, error-free causal loop diagrams that reveal reinforcing and balancing dynamics driving system behavior
---
