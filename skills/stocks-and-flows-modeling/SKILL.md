---
name: stocks-and-flows-modeling
description: Use when predicting system behavior over time, calculating equilibrium states, analyzing accumulation dynamics, or modeling delays - provides formal notation, quantitative techniques, and validation methods to rigorously model how stocks accumulate and deplete, avoiding intuition failures in non-linear or delayed systems
---
